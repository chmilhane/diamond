do
  ...
  local _base_0 = {
    __name = "Diamond.Animations.Lerp",
    ...
    onThink = function(self, anim, panel, fraction)
      ...
      local value = (function() local __laux_nilish_coalescing_var = panel[index]if __laux_nilish_coalescing_var ~= nil then return __laux_nilish_coalescing_var else return 0 end end)()
      panel[index] = Lerp(fraction, value, goal)
    end,
  ...
  _class_0 = setmetatable({
    __init = function(self, index, goal, ...)
      ...
      Diamond.Animations.Lerp.__parent.__init(self, ...)
  ...
  Diamond.Animations.Lerp = _class_0
end
